...
//     link.href = eventData.qrCodeData;
...
//   const openEventUrl = () => {
//     const url = `${window.location.origin}/event/${eventData.eventSlug}`;
...
//                 Your event &ldquo;{eventData.title}&rdquo; is now live
//               </p>
//             </div>
//             <button
//               onClick={onClose}
...
//               <input
//                 type="text"
//                 value={`${window.location.origin}/event/${eventData.eventSlug}`}
//                 readOnly
