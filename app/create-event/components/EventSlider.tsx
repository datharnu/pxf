    ...
    <section className="relative w-full h-screen text-white overflow-hidden">
      ...
      <div className="relative z-10  mt-24">
        <div className="z-10 flex gap-5 justify-center lg:gap-16 h-full px-4 md:px-16">
          {/* Phone Mockup */}
          <div className="">
            <div className="lg:w-[270px] lg:h-[560px] w-[200px] h-[400px] rounded-[40px] overflow-hidden shadow-2xl border-[6px] border-black bg-black">
              <img
                src={current.image}
                alt={current.title}
          ...
          <div className="max-w-xl lg:text-left">
            ...
            <button className="font-ghotic lg:mt-10 lg:text-xl text-lg highway-ghotic flex items-center lg:gap-5 gap-2 bg-gradient-to-r from-yellow-400 via-yellow-500 to-orange-500  py-1 px-1 pl-2 lg:px-2 lg:py-2 lg:pl-4 font-bold rounded-full ">
              Create an Event
